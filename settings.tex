...
\newcommand{\titelpagina}[1]{
    ...
    \newlength{\y@logobedrijfa}
    \newlength{\x@logobedrijfa}
    \newlength{\y@logobedrijfb}
    \newlength{\x@logobedrijfb}
    \newlength{\y@titel}
    \newlength{\x@recttop}
    \newlength{\y@rectbottom}
    \newlength{\height@logobedrijfa}
    \newlength{\height@logobedrijfb}
    \newlength{\x@titel}

    \setlength{\y@logobedrijfa}{6.5cm} %set
    \setlength{\x@logobedrijfa}{16cm} %set
    \setlength{\y@logobedrijfb}{6.5cm} %set
    \setlength{\x@logobedrijfb}{10cm} %set
    \setlength{\y@titel}{4.5cm}
    \setlength{\x@recttop}{5cm}
    \setlength{\y@rectbottom}{4cm}
    \setlength{\height@logobedrijfa}{3.4cm} %set
    \setlength{\height@logobedrijfb}{3.4cm} %set
    \setlength{\x@titel}{12cm}
    ...
    \begin{titlepage}
        ...
        \makebox[\textwidth]{%
            ...
            \begin{tikzpicture}[
                ...
                \draw [fill=purple] (0,\paperwidth) rectangle (\x@recttop,16);

                \draw [fill=purple] (10.5,\paperwidth) rectangle (5.5,15);

                \draw [fill=purple] (15.5,\paperwidth) rectangle (11,\paperwidth);

                \node at (\x@logobedrijfa,\y@logobedrijfa) {   
                \includegraphics[height=\height@logobedrijfa]{logo/#1}
                };

                % \node at (\x@logobedrijfb,\y@logobedrijfb) {
                % \includegraphics[height=\height@logobedrijfb]{logo/...} %logo van ander bedrijf
                % };

                \node[scale=2] at (\x@titel,\y@titel) {\hbox{\sffamily \titel}};
