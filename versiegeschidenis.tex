...
\versiehistorie{
	...
	Hoofdstukken toegevoegt
	& JHT
	\\ \hline
    24-03-2026 & 0.1 & 
	Instellingen, versiehistory en titelpagina toegevoegt %\lcode{\\hurl} toegevoegd, Rust toegevoegd in \cref{sec:listings}, info over syntaxiskleuring toegevoegd in \cref{sec:syntaxiskleuring} en meerdere figuren naast elkaar in \cref{sec:meerderefiguren}.
	& JHT %\mailafko{BroJZ}
}
