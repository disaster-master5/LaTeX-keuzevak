...
\vspace{5mm}
In \cref{fig:driefase_spanningen} zij de 3 verschillende fase spanningen te zien.

\begin{figure}
    \begin{center}
    \includegraphics[width=0.5\linewidth]{afbeeldingen/IMG-20260326-WA0006.jpg}
    \caption{Spanningen van de 3 verschillende fase}
    \label{fig:driefase_spanningen}
    \end{center}
\end{figure}
...
\section{$\Delta -\Delta $ configuratie} %later onderzoeken wat warning betekend. lijkt geen invloet op pdf te hebben

Dit is de schakeling voor de $\Delta -\Delta $ / delta - delta of driehoek - driehoek, configuratie.
%schakeling driehoek driehoek
\begin{center}
    \begin{circuitikz}
...
Meer informatie over het gebruik en rekenen aan symetrische driefasen schakelingen is te vinden in hoofdstuk 5.7 van het 
boek van Hambley \cite{leerboek}.